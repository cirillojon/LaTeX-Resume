%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Jonathan Cirillo Resume (As of 9/5/2023)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hspace{1cm}\descript{Stack: Python, Docker, GitSwarm, Selenium, Linux}
\begin{tightemize}
...
\hspace{1cm}\descript{Stack: Go, Azure, Docker, Kubernetes, CouchDB, Consul, Grafana}
\begin{tightemize}
...
\hspace{1cm}\descript{Stack: C\#, Java, SQL, Powershell, Cherwell}
\begin{tightemize}
...
\hspace{1cm}\descript{Stack: JavaScript, C\#, SQL, Liquid Office}
\begin{tightemize}
...
\hspace{1cm}\descript{Stack: Flutter, Dart, Unity, C\#, Firebase \hfill
...
\descript{| Lead Developer \& Project Manager}
\hspace{1cm}\descript{Stack: Java, LaTeX, IntelliJ, Guava \hfill \href{https://cirillojon.herokuapp.com/images/Final-Paper.pdf}{Link to Paper}}
\begin{tightemize}
...
\hspace{1cm}\descript{Stack: JavaScript, MongoDB, Express, React.js, Node.js \hfill \href{https://trendify-project.herokuapp.com/}{Link to Project}}
\begin{tightemize}
