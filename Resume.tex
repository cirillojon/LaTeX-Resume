%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Jonathan Cirillo Resume (As of 8/11/2023)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\runsubsection{VS \& CO.}
\descript{| Applications Developer Intern \hfill  May 2022 – May 2023 }
...
\descript{Data Management and Tools: Firebase \textbullet{} MongoDB \textbullet{} PostgreSQL \textbullet{} Docker \textbullet{} MySQL \textbullet{} Azure \textbullet{} Kubernetes}
\descript{Libraries and Frameworks: 
React.js \textbullet{} Node.js \textbullet{} Flutter \textbullet{}
Keras \textbullet{} Django \textbullet{} Flask \textbullet{} .NET \textbullet{} Unity \textbullet{} FastAPI}
\sectionsep\
\hfill
\vfill\eject
