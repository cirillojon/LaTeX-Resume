...
\descript{ Python, GitSwarm, Confluence}
\begin{tightemize}
...
\descript{Go, Azure, Kubernetes, Docker, CouchDB, MongoDB, Consul, Grafana}
\begin{tightemize}
...
\descript{C\#, Java, SQL, Powershell, .NET, WPF, Bitbucket, Cherwell}
\begin{tightemize}
...
\descript{JavaScript, C\#, Liquid Office, Budibase}
\begin{tightemize}
...
Keras \textbullet{} .NET \textbullet{} Unity }
\sectionsep\
\hfill
\vfill\eject
