%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Jonathan Cirillo Resume (As of 4/21/2023)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\location{Aug 2022 – Present | Remote}
\begin{tightemize}
...
\descript{ |  2023 }
\descript{Unity, C\#, Python, Firebase, Blender, Figma, SpoonacularAPI \hfill \href{https://arcuttingboard.com/}{Link to Website}}
\begin{tightemize}
...
\descript{Programming Languages:  Java \textbullet{} Go \textbullet{}  C\# \textbullet{} C \textbullet{} JavaScript \textbullet{} Python \textbullet{} SQL \textbullet{} LaTeX }  
